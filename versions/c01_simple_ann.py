# ==================================
# Classifier 1 Versions - Simple ANN
# ==================================
...
from functions import setup_keras_environment, load_and_prepare_data, simple_ann

def iter1(x_train, y_train, x_test, y_test):
    print("\n [-] Iteration 1 (Baseline)...")
    acc, prec, rec, f1, prob, model = simple_ann(
...
def iter2(x_train, y_train, x_test, y_test):
    ...
    acc, prec, rec, f1, prob, model = simple_ann(
        ...
        epochs=15,
        batch_size=256,
        description="Increased hidden neurons (128 -> 256) and epochs (5 -> 15) to boost baseline accuracy.",
    )
...
def main(target_iter):
    print("# ======================================================")
    print(f"# RUNNING CLASSIFIER 1 VERSIONS (SIMPLE ANN) - Mode: {target_iter}")
    print("# ======================================================\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run specific iterations of the Simple ANN classifier.")
    parser.add_argument(
        "--iter",
        type=str,
